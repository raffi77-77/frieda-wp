	...
	<div class="container">
			...
			<div class="symptoms-wrap">
				...
				<div class="range-wrap">
					<input type="range" id="volume" name="volume" min="0" max="10" value="<?= $data['question3']; ?>" step="1" labels="0, 2, 4, 6, 8, 10" disabled>
				</div>
			</div>
			<div class="symptoms-wrap">
				<h2>
				...
				<div class="range-wrap">
					<input type="range" id="volume" name="volume" min="0" max="10" value="<?= $data['question4']; ?>" step="1" labels="0, 2, 4, 6, 8, 10" disabled>
				</div>
			</div>
			<div class="symptoms-wrap">
				<h2>
