...
$symptoms_tracker_list_fields = get_field( 'symptom_tracker_list' );
?>
<div class="trackingdairy-section tracking-section">
    <div class="container">
        <h3><?php echo $symptoms_tracker_list_fields['header_title'] ?? ''; ?></h3>
        <p class="paragraph"><?php echo $symptoms_tracker_list_fields['header_description'] ?? ''; ?></p>
        ...
        <div class="toolbox-record">
			<?php if ( $results && count( $results ) ) { ?>
                <table id="data">
                            ...
                            <tr>
                                ...
                                <td>
									...
									if ( $data['question5'] && count( $data['question5'] ) ) {
										...
										?>
                                        <img class="emoji" src="<?= $img; ?>" alt="q-img"/>
									<?php } ?>
                                </td>
                                <td>
                    ...
                    <script>window.jsonData = <?= json_encode( [ 'labels'   => $labels,
					                                             'datasets' => [ $datasets ]
						] ); ?>;</script>
                </table>
			<?php } else { ?>
